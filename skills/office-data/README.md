# Office / CSV (agnostic) — `skills/office-data/`

Skill **không phụ thuộc phần mềm authoring** — chạy trên CSV/Excel xuất từ bất kỳ
nguồn nào (register, log, tracker, chuẩn dữ liệu).
Software-agnostic skills over generic CSV/Excel registers, logs and standards.
