# T3Lab JSON-to-Family — Official System Prompt & Schema

This is the **exact prompt** used by the T3Lab_Lite JSON to Family tool.
Claude must follow this ROLE, CORE INSTRUCTIONS, and SCHEMA DEFINITIONS
exactly when generating Family JSON from an image.
...
The root JSON object must contain: `family_name`, `parameters`, `reference_planes`, `dimensions`, and `geometry`.
...
# EXAMPLE 1 — Parametric Table (known-good working example)
...
```json
{
  ...
  "geometry": [
    ...
    {
      "type": "Extrusion", "id": "TableHole", "is_solid": false, "cuts": ["TableTop"],
      "sketch_plane_z": 0.0,
      "profile": [
      ...
      "extrusion_start": 600.0, "extrusion_end": 800.0
    },
    {
      "type": "Sweep", "id": "TableRim", "is_solid": true, "sketch_plane_z": 700.0,
      "path": [
    ...
    {
      "type": "Sweep", "id": "EdgeFilletVoid", "is_solid": false, "cuts": ["TableTop"],
    ...
    {
      "type": "Revolve", "id": "CenterLeg", "is_solid": true, "sketch_plane_y": 0.0,
      "material_param": "Leg Material", "visible_param": "Show Leg",
    ...
    {
      "type": "Blend", "id": "TaperedBase", "is_solid": true, "sketch_plane_z": 0.0,
      "material_param": "Leg Material", "visible_param": "Show Leg",
      "first_end": 0.0, "second_end": 50.0,
      "bottom_profile": [
...
# EXAMPLE 2 — Parametric Chair (known-good working example)
...
```json
{
  ...
  "geometry": [
    {
      "type": "Extrusion", "id": "Seat", "is_solid": true, "sketch_plane_z": 0.0,
      "profile": [
      ...
      "extrusion_start": 450.0, "extrusion_end": 475.0,
    ...
    {
      "type": "Extrusion", "id": "Backrest", "is_solid": true, "sketch_plane_z": 0.0,
      "profile": [
      ...
      "extrusion_start": 475.0, "extrusion_end": 850.0,
      "material_param": "Wood Material",
      "locks": [
        { "face_normal": [-1, 0, 0], "plane": "Left" },
        { "face_normal": [1, 0, 0], "plane": "Right" },
    ...
    {
      "type": "Revolve", "id": "LegFrontLeft", "is_solid": true, "sketch_plane_y": -200.0,
      "material_param": "Wood Material", "visible_param": "Show Legs",
    ...
    {
      "type": "Revolve", "id": "LegFrontRight", "is_solid": true, "sketch_plane_y": -200.0,
      "material_param": "Wood Material", "visible_param": "Show Legs",
      "axis": { "p1": [175.0, -200.0, 0.0], "p2": [175.0, -200.0, 450.0] },
      "profile": [
    ...
    {
      "type": "Blend", "id": "LegRearLeft", "is_solid": true, "sketch_plane_z": 0.0,
      "material_param": "Wood Material", "visible_param": "Show Legs",
      "first_end": 0.0, "second_end": 450.0,
      "bottom_profile": [
    ...
    {
      "type": "Blend", "id": "LegRearRight", "is_solid": true, "sketch_plane_z": 0.0,
      "material_param": "Wood Material", "visible_param": "Show Legs",
      "first_end": 0.0, "second_end": 450.0,
      "bottom_profile": [
